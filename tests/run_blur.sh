...
PERF_PATH="/home/cecconi/GPUfarm/log/blur"
...
. "$SCRIPT_PATH/monitor_blur.sh" &

sleep 7

echo -e "${GREEN}running script dev_blur_dp_str_P100.sh${NC}"
echo ""
echo "***dev_blur_dp_str_P100.sh***">> "$PERF_PATH/launch_times.txt"
echo "start: $(date)">> "$PERF_PATH/launch_times.txt"
. "$SCRIPT_PATH/dev_blur_dp_str_P100.sh"
