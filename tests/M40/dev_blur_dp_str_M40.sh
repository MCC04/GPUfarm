...
do	
	...
	echo -ne "$nTests \n"			
	nvprof --log-file ./profiling/dev_blur_dp$N-$m-$B.txt ./bin/mat/blurbox.out $GPU $B 0 0 $N $N 1 >> ./results/dev_blur_dp_str.txt
...
do	
	...
	do
		...
		echo -ne "$nTests \n"			
		nvprof --log-file ./profiling/dev_blur_str$N-$m-$B-0.txt ./bin/mat/blurbox.out $GPU $B 0 0 $N $N $m >> ./results/dev_blur_dp_str.txt
...
do	
	...
	do
		...
		echo -ne "$nTests \n"			
		nvprof --log-file ./profiling/dev_blur_str$N-$m-$B-0.txt ./bin/mat/blurbox.out $GPU $B 1 3 $N $N $m >> ./results/dev_blur_dp_str.txt
...
do	
	...
	do
		...
		echo -ne "$nTests \n"			
		nvprof --log-file ./profiling/dev_blur_str$N-$m-$B-0.txt ./bin/mat/blurbox.out $GPU $B 1 0 $N $N $m >> ./results/dev_blur_dp_str.txt
